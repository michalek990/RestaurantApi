...
namespace ResteurantApi.Migrations
{
    ...
    [Migration("20221023150611_autoryzacjaa")]
    partial class autoryzacjaa
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResteurantApi.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ResteurantApi.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ResteurantApi.Entities.Resteurant", b =>
                {
                    ...
                    b.HasOne("ResteurantApi.Entities.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("ResteurantApi.Entities.User", b =>
                {
                    b.HasOne("ResteurantApi.Entities.Role", "Role")
                        .WithMany()
